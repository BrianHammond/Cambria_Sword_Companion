...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        Form.setWindowTitle(QCoreApplication.translate("Form", u"About Cambria Sword Companion", None))
        self.label.setText(QCoreApplication.translate("Form", u"Cambria Sword Companion", None))
